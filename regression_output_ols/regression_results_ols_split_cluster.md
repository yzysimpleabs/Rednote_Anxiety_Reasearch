# 样本拆分 + 聚类稳健标准误（按 koc_id 聚类）

数据来源：DMS001_enriched.csv；样本按 high_or_low=low/high 拆分；对连续变量已做 1% 缩尾处理。

## Model1_CollectLikeRatio_low
